-- Тестовые данные для таблицы films
-- 6 фильмов из mongodb_initial_stub.json

INSERT INTO films (id, title, rating, director, tags, about, description, image, cover) VALUES
('0e33c7f6-27a7-4aa0-8e61-65d7e5effecf', 'Архитекторы общества', 2.9, 'Итан Райт', '{"Документальный"}', 
...
('51b4bc85-646d-47fc-b988-3e7051a9fe9e', 'Недостижимая утопия', 9.0, 'Харрисон Рид', '{"Рекомендуемые"}',
...
('3bedbc5a-844b-40eb-9d77-83b104e0cf75', 'Звёздное путешествие', 8.5, 'Элиза Уиттакер', '{"Рекомендуемые"}',
...
('5b70cb1a-61c9-47b1-b207-31f9e89087ff', 'Стражи Гримуара', 8.9, 'Лила Васкес', '{"Рекомендуемые"}',
...
('0354a762-8928-427f-81d7-1656f717f39c', 'Парадокс Нексуса', 9.5, 'Оливер Беннет', '{"Рекомендуемые"}',
...
('92b8a2a7-ab6b-4fa9-915b-d27945865e39', 'Сон в летний день', 8.1, 'Амелия Хьюз', '{"Рекомендуемые"}',
